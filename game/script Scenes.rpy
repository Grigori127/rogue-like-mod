...
label Love_You(Girl=0):
        ...
        if CheckWord(Girl,"Traits","lover"):
                #if you cleared the love scene with her. . .
            ...
            if Girl == "Rogue":
                    if not R_Event[6]:
                            ...
                            $ Line = "never"                    
                    elif "lover" not in R_Traits and R_Event[6] >= 20: 
                            # if she's asked you, but you refused before. . .
                            call Rogue_Love_Redux
            elif Girl == "Kitty":
                    if not K_Event[6]:
                            $ Line = "never"                    
                    elif "lover" not in K_Traits and K_Event[6] >= 20: 
                            call Kitty_Love_Redux
            elif Girl == "Emma":
                    if not E_Event[6]:
                            # if you've never had the "love" talk. . .
                            $ Line = "never"                    
                    elif "lover" not in E_Traits and E_Event[6] >= 20: 
                            call Emma_Love_Redux
            elif Girl == "Laura":
                    if not L_Event[6]:
                            $ Line = "never"                    
                    elif "lover" not in L_Traits and L_Event[6] >= 20: 
