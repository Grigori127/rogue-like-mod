...
#                            style "say_balloon"         
            ...
            if who == "Rogue":
                    ...
                    if L_SpriteLoc == StageRight or L_SpriteLoc == StageFarRight:
                        add "arrow" rotate -90 xzoom -1 xpos 1.03 ypos -0.85                        
                    elif L_SpriteLoc == StageFarLeft:
                        add "arrow" xalign 0.1 #xzoom -1
                    else: #L_SpriteLoc == StageCenter, Left, etc.:
                        add "arrow" xalign 0.8    
            elif who == GwenName: 
#                    if L_SpriteLoc == StageRight or L_SpriteLoc == StageFarRight:
#                        add "arrow" rotate -90 xzoom -1 xpos 1.03 ypos -0.85                        
...
#            hbox:
#                if "Rogue" in Nearby:
#                    imagebutton auto "images/Button_Rogue_%s.png" action NullAction() hovered tt.Action("Rogue")
#                if "Kitty" in Nearby:
#                    imagebutton auto "images/Button_Kitty_%s.png" action NullAction() hovered tt.Action("Kitty")
#                if "Emma" in Nearby:
#                    imagebutton auto "images/Button_Emma_%s.png" action NullAction() hovered tt.Action("Emma")
#                if "Laura" in Nearby:
#                    imagebutton auto "images/Button_Laura_%s.png" action NullAction() hovered tt.Action("Laura")
#        zoom .3
